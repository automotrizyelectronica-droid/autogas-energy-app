...
# --- 1. CONFIGURACIÓN DE NUBE (Supabase y Cloudinary) ---
cloudinary.config(
...
# Credenciales directas de Supabase (Nivel Pro, sin Google Sheets ni errores 403)
        ...
        if st.button("✅ FINALIZAR Y GUARDAR TODO"):
            with st.spinner("Subiendo datos y fotos a Supabase (Pro)..."):
                try:
                    ...
                    if res.data:
                        st.success("¡Servicio Guardado con Éxito en la Base de Datos Pro!")
